...
import math
from pydelmod import dsm2study
...
def generate_channel_orientation(
    ...
    with open(channel_orient_file, "w") as f:
        pydsm.input.parser.write(f, {"CHANNEL_ORIENTATION": df})


if __name__ == "__main__":
    generate_channel_orientation()
...
# generate_channel_orientation(
#     channel_line_geojson_file, hydro_echo_file, "channel_orient.csv"
# )
